    ...
    <div className="min-h-full bg-gradient-to-b from-white to-gray-50">
      <article className="container mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        <div className="mt-10 space-y-8 text-gray-700">
          <section>
            <h2 className="text-xl font-bold text-gray-900">What is an AI humanizer?</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">Turnitin, AI detection, and similarity</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900">Try the AI humanizer</h2>
            <p className="mt-3 leading-relaxed">
