...
export default function AboutPage() {
  return (
    <div className="min-h-full bg-gradient-to-b from-slate-50/80 via-white to-rose-50/30 dark:from-zinc-950 dark:via-black dark:to-zinc-950">
      <article className="container mx-auto max-w-3xl px-4 py-14 md:py-20">
        ...
        <h1 className="mt-3 text-center text-3xl font-bold tracking-tight text-gray-900 dark:text-zinc-50 md:text-4xl">
          Writing tools built for natural, confident results
        </h1>
        <p className="mx-auto mt-5 max-w-2xl text-center text-lg leading-relaxed text-gray-600 dark:text-zinc-300">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="rounded-full border-gray-200/80 bg-white/60 backdrop-blur-sm dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:bg-zinc-800"
          >
