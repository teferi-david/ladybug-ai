  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-5xl px-4">
        <div className="rounded-[2rem] border border-violet-200/80 bg-gradient-to-br from-violet-100/90 via-white to-fuchsia-50/80 p-4 shadow-[0_20px_60px_rgba(139,92,246,0.12)] md:p-8">
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    t.active &&
                      'bg-white/80 shadow-sm ring-1 ring-violet-200/80'
                  )}
                >
                  ...
                  <span
                    className={cn(
                      ...
                      t.active ? 'text-violet-800' : 'text-gray-600'
                    )}
                  >
                    {t.label}
                  </span>
                  <span className="text-[11px] leading-tight text-gray-500">{t.sub}</span>
                </div>
              )
            })}
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="flex flex-col rounded-2xl border border-red-100 bg-white/90 p-4 shadow-sm">
              ...
              <p className="min-h-[180px] flex-1 rounded-xl border border-gray-100 bg-gray-50/80 p-4 text-sm leading-relaxed text-gray-700">
                {ORIGINAL}
              </p>
            </div>

            <div className="flex flex-col rounded-2xl border border-emerald-100 bg-white/90 p-4 shadow-sm">
              <div className="mb-3 flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 text-sm font-semibold text-gray-900">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-xs font-medium text-emerald-800">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              ...
              className="group relative inline-flex min-h-12 items-center justify-center gap-2 overflow-hidden rounded-full border border-violet-200 bg-white px-10 py-3 text-sm font-semibold text-violet-900 shadow-[0_12px_40px_rgba(139,92,246,0.35)] transition hover:bg-violet-50"
            >
              <Brain className="h-5 w-5 text-violet-700" aria-hidden />
