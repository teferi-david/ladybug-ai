      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          <div className="liquid-glass-bubble flex flex-col rounded-3xl p-6 md:p-8">
            <h3 className="text-lg font-bold text-gray-900 dark:text-zinc-50">Basic</h3>
            <p className="mt-1 text-sm text-gray-600 dark:text-zinc-400">500k words/year across tools</p>
            <p className="mt-4">
          ...
          <div className="liquid-glass-bubble flex flex-col rounded-3xl p-6 ring-2 ring-primary/25 md:p-8">
            <div className="flex items-center justify-between gap-2">
              <h3 className="text-lg font-bold text-gray-900 dark:text-zinc-50">Unlimited</h3>
              <span className="rounded-full bg-primary/15 px-2 py-0.5 text-xs font-semibold text-primary">
                Popular
              </span>
            </div>
            <p className="mt-1 text-sm text-gray-600 dark:text-zinc-400">No word cap across tools</p>
            <p className="mt-4">
        ...
        <p className="mt-8 text-center text-xs text-gray-500 dark:text-zinc-400">
